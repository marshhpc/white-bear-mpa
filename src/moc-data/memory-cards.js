const memoryCards = [
   ...
   },
   {
      ...
      imagery:
         "This is the second card, so i can test to see if my code works.",
      answer: "Still checking to see if it will work",
   ...
   },
   {
      ...
      imagery: "This is set to test my data to see how it works, card 4",
      answer: 'The technical term for a hashtag is "octothorpe."',
      createdAt: 1594070860724,
      nextAttemptAt: 1593812075634,
      lastAttemtAt: 1593812075634,
